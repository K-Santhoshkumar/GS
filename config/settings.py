...
SECRET_KEY = "django-insecure-ld&tr=v9-_i@d8(&9s26qtfi-epl@y@4lpor8yib9tqg7xy90h"
...
user_apps = ["otps", "users.apps.UsersConfig", "funddetails", "homepage"]
...
# CSRF cookie settings to improve CSRF token handling
